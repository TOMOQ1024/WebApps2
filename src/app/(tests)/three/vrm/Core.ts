...
import { GLTF, GLTFLoader, OrbitControls } from 'three/examples/jsm/Addons';
...
export default class Core {
  ...
  constructor() {
    ...
    (async (cvs: HTMLCanvasElement, scene: THREE.Scene) => {
      this.gltf = (await loader.loadAsync('/models/8040001587529932248.vrm'));
      // this.gltf = (await loader.loadAsync('/models/Ogame.vrm'));
