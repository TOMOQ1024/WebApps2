...
const TopPage = () => {
  return (
    <main className="relative w-full min-h-screen overflow-x-hidden">
      {/* スクロール可能なコンテンツエリア */}
      <div className="relative z-[100] w-full pointer-events-none [&_section]:pointer-events-auto [&_section]:p-8 [&_section]:my-8 [&_section]:mx-auto [&_section]:max-w-[800px] [&_section]:border-2 [&_section]:border-[var(--border-color)] max-md:[&_section]:m-4 max-md:[&_section]:p-4">
        {/* Hero Section */}
        ...
        <section>
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-4 mt-4">
            {[
              ...
              <div
                key={item.title}
                className="border-2 border-[var(--border-color)] p-4"
              >
