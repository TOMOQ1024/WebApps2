...
export default function handler(
  ...
  const vertPath = path.resolve('./public', 'resources', 'sierpinskigasket', 'shaders', 'vert.wgsl');
  const fragPath = path.resolve('./public', 'resources', 'sierpinskigasket', 'shaders', 'frag.wgsl');
